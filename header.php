...
<html lang="en">
  <head>
    <title>Khusboo's Portfolio</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav id="colorlib-main-nav" role="navigation">
      ...
      <div class="js-fullheight colorlib-table">
        <div class="img" style="background-image: url(images/pp.jpg);"></div>
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">Khusboo Shrestha</a></h1>
              <ul>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="colorlib-navbar-brand">
                <a class="colorlib-logo" href="index.php"><span class="logo-img" style="background-image: url(images/pp.jpg);"></span>Khusboo Shrestha</a>
              </div>
